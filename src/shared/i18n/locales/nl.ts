...
export const nl: Partial<Record<MessageKey, unknown>> = {
  ...
  "models.gpu.title": "GPU-versnelling",
  "models.gpu.subtitle": "Draai Whisper op je NVIDIA-kaart in plaats van op de processor.",
  "models.gpu.ready": "Whisper gebruikt je videokaart",
  "models.gpu.notInstalled": "Whisper draait op de processor. De CUDA-versie is een download van {size}.",
  "models.gpu.installing": "CUDA-versie installeren",
  "models.gpu.failed": "Installeren van CUDA is mislukt",
  "models.gpu.installBtn": "CUDA installeren",
  "models.gpu.installingBtn": "Bezig",
