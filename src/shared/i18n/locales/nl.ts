...
export const nl: Partial<Record<MessageKey, unknown>> = {
  ...
  "meetings.setup.title": "Vergaderingen hebben een paar kleine modellen nodig",
  "meetings.setup.body": "Een stemdetector, een sprekersvingerafdruk en een segmentatiemodel worden eenmalig geïnstalleerd naast je transcriptiemodel.",
  "meetings.setup.optional": "Optioneel",
  "meetings.setup.downloading": "Ondersteunende modellen downloaden...",
  "meetings.setup.install": "{size} downloaden",
